...
def process_geotiff(input_file, output_file,relative_date,num_windows,groundtruth_called):
    ...
    with rasterio.open(input_file) as src:
        ...
        groundtruth1m_file=output_file.replace("layer","groundtruth-onemonth")
        create_groundtruth1m = not os.path.isfile(groundtruth1m_file)
        groundtruth3m_file=output_file.replace("layer","groundtruth-threemonths")
        create_groundtruth3m = not os.path.isfile(groundtruth3m_file)
        groundtruth6m_file=output_file.replace("layer","groundtruth-sixmonths")
        create_groundtruth6m = not os.path.isfile(groundtruth6m_file)
        groundtruth12m_file=output_file.replace("layer","groundtruth-twelvemonths")
