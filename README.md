...
| :-------- | :------- | :-------- | :------- | :-------- |
|groundtruth6mbin|binary groundtruth of oncoming six months|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every hotzone where at least 1 deforestation event happens is classified as an actual (value 1)|
|groundtruth1m|groundtruth of oncoming month in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every hotzone where at least 1 deforestation event happens is classified as an actual (value 1)|
|groundtruth3m|groundtruth of oncoming 3 months in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every hotzone where at least 1 deforestation event happens is classified as an actual (value 1)|
|groundtruth6m|groundtruth of oncoming 6 months in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every hotzone where at least 1 deforestation event happens is classified as an actual (value 1)|
|groundtruth12m|groundtruth of oncoming 12 months in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every hotzone where at least 1 deforestation event happens is classified as an actual (value 1)|
...
|confidence|average confidence of alerts|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|The average confidence of the alerts, which are between 2 and 4 meaning low to highest confidence with NA removed|
|elevation|elevation|static|[SRTM](https://csidotinfo.wordpress.com/data/srtm-90m-digital-elevation-database-v4-1/)|the average elevation of the SRTM rasters when aggregated to the hotzone level in meters above sea level|
...
|initialforestcover|forest mask of 2019|static|[GLAD FSC alerts](https://glad-forest-alert.appspot.com/)|The sum of the underlying pixels where every pixel is a fraction of canopy cover and every pixel that has been deforested between 2001 and 2018 is set to 0|
|lastsixmonths|deforestation last six months|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|takes the sum of the underlying 1600 pixels that have been deforested in the last 6 months|
|lastthreemonths|deforestation last three months|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|takes the sum of the underlying 1600 pixels that have been deforested in the last 3 months|
...
|patchdensity|patchiness of last six months of deforestation|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|the deforestation of the last six months is taken as input and processed by giving every group of deforestation pixels a unique value. The total amount of unique values within the hotzone is the result, representing the amount of deforestation patches in the last 6 months|
|peatsoil|areas with a peat soil|static|[CIFOR](https://data.cifor.org/dataset.xhtml?persistentId=doi:10.17528/CIFOR/DATA.00058)|the data is aggregated to 400x400 and represents the average depth of the peat soil in meters with a maximum of 15 meters|
|populationcurrent|current population|static|[EUPOP](https://ghsl.jrc.ec.europa.eu/download.php)|This is the POP2025 dataset that is first reprojected to the hotzone resolution with the max function and then a gradual filter of 25 pixels is applied to smooth it over a larger area|
|populationincrease|population increase|static|[EUPOP](https://ghsl.jrc.ec.europa.eu/download.php)|This is the difference between POP2030 and POP2020 dataset that is first reprojected to the hotzone resolution with the max function and then a gradual filter of 25 pixels is applied to smooth it over a larger area|
...
|smoothedsixmonths|deforestation last six months smoothed|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|A smoothed version of layer lastsixmonths|
|smoothedtotal|total deforestation smoothed|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|A smoothed version of layer totaldeforestation|
