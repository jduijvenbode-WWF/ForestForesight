...
|groundtruth1m|groundtruth of oncoming month in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every 400x400m pixel where at least 1 deforestation event happens is classified as an actual (value 1)|
|groundtruth3m|groundtruth of oncoming 3 months in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every 400x400m pixel where at least 1 deforestation event happens is classified as an actual (value 1)|
|groundtruth6m|groundtruth of oncoming 6 months in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every 400x400m pixel where at least 1 deforestation event happens is classified as an actual (value 1)|
|groundtruth12m|groundtruth of oncoming 12 months in amount of pixels|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every hotz400x400m pixelone where at least 1 deforestation event happens is classified as an actual (value 1)|
...
|populationcurrent|current population|static|[EUPOP](https://ghsl.jrc.ec.europa.eu/download.php)|This is the POP2025 dataset that is first reprojected to the 400x400m pixel resolution with the max function and then a gradual filter of 25 pixels is applied to smooth it over a larger area|
|populationincrease|population increase|static|[EUPOP](https://ghsl.jrc.ec.europa.eu/download.php)|This is the difference between POP2030 and POP2020 dataset that is first reprojected to the 400x400m pixel resolution with the max function and then a gradual filter of 25 pixels is applied to smooth it over a larger area|
