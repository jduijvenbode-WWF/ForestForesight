...
|confidence|average confidence of alerts|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|The average confidence of the alerts, which are between 2 and 4 meaning low to highest confidence|
|elevation|elevation|static|[SRTM](https://csidotinfo.wordpress.com/data/srtm-90m-digital-elevation-database-v4-1/)|the average elevation of the SRTM rasters when aggregated to the hotzone level|
|firealerts|forest fire alerts from VIIRS and other satellites|monthly|[VIIRS LAADS-DAAP](https://firms.modaps.eosdis.nasa.gov/download/)|the data is downloaded for all sensors for historic data and from now on monthly for near real time data. The point shapefiles are rasterized with the sum of all points within the pixel.|
|forestheight|height of forest 2020|yearly|[GLAD](https://glad.umd.edu/users/Potapov/GLCLUC2020/Forest_height_2020/)|this dataset is available till 2020|
|groundtruth|groundtruth|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|every hotzone where at least 1 |deforestation event happens is classified as an actual (value 1)|
|historicloss|GLAD deforestation 2001-2018|static|[GLAD FSC alerts](https://glad-forest-alert.appspot.com/)|The total number of pixels between 2001 and 2018|
...
|nightlights|nighttime activity as measured by the VIIRS satellite|monthly|[VIIRS LAADS-DAAP](https://ladsweb.modaps.eosdis.nasa.gov/archive/allData/5000/VNP46A3/2023)|monthly cloud-corrected nighttime activity (visible light/SWIR radiation at night)|
|patchdensity|patchiness of last six months of deforestation|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|the deforestation of the last six months is taken as input and processed by giving every group of deforestation pixels a unique value. The total amount of unique values within the hotzone is the result|
|peatsoil|areas with a peat soil|static|[CIFOR](https://data.cifor.org/dataset.xhtml?persistentId=doi:10.17528/CIFOR/DATA.00058)|the data is aggregated to 400x400 and |reclassified from categorical values to 1/0 for peat soil no wetland by taking any value above 0|
|populationcurrent|current population|static|[EUPOP](https://ghsl.jrc.ec.europa.eu/download.php)|This is the POP2025 dataset that is first reprojected to the hotzone resolution with the max function and then a gradual filter of 25 pixels is applied|
|populationincrease|population increase|static|[EUPOP](https://ghsl.jrc.ec.europa.eu/download.php)|This is the difference between POP2030 and POP2020 dataset that is first reprojected to the hotzone resolution with the max function and then a gradual filter of 25 pixels is applied|
|precipitation|predicted precipitation |monthly|[CMIP6 precipitation predictions](https://cds.climate.copernicus.eu/cdsapp#!/dataset/projections-cmip6-decadal-prototype?tab=form)|Averaged (median) over all 16 scenarios and with a cubic resampling resampled to hotzones|
...
|sinmonth|the sine of the date|static|autogenerated|this is autogenerated in the preprocessing|
...
|smoothedsixmonths|deforestation last six months smoothed|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|A smoothed version of layer Defo6mLst|
|smoothedtotal|total deforestation smoothed|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|A smoothed version of layer TotlDefor|
|timesinceloss|latest moment of deforestation|monthly|[GFW alerts](https://www.globalforestwatch.org/blog/data-and-research/integrated-deforestation-alerts/)|This is classified as the fraction of time|
...
|x|latitude |static|autogenerated|this is autogenerated in the preprocessing|
|y|longitude|static|autogenerated|this is autogenerated in the preprocessing|
...
|wdpa|WDPA status|yearly|[Protected Planet](https://www.protectedplanet.net/en/thematic-areas/wdpa)|the data was intersected with land area and the tiles that we have, then simplified to 200 meters and then rasterized|
