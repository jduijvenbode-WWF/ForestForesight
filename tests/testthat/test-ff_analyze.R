test_that("tests to see if ff_analyze works", {
  ...
  testthat::expect_no_error(polygons <- ff_analyze(predictions = predictions, groundtruth = groundtruth, forest_mask = forestmask, remove_empty = FALSE, csv_filename = file.path(test_dir, "test.csv")))
